# Contributing to GetIrishWeather
...
- Prefer British or Irish spelling and grammar conventions in all comments,
  issues, commits, pull requests, and other communications. (This reduces
  Copilot comment spam.)
